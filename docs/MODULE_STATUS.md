...
| Customers      | Delvis implementerad | Server-side ownerintegritetskedja är verifierad. Routeintegration, bootstrap, tenanttabell, audit, mutationer och DAL saknas; modulen är inte verksamhetsklar. |
