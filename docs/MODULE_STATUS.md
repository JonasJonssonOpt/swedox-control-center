...
| Installations  | DAL/service verifierat | F2C1–F2C6B:s databasgrund och strikt server-only DAL/service med ownerguard, request-lokal SSR, runtimevalidering, list/detail-separation, audit och sju mutationer är lokalverifierade. Routes, actions och UI saknas; Installation Management är inte verksamhetsklart. |
