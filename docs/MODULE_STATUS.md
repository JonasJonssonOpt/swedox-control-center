...
| Licenses       | Analyserad · beslutad  | F2D1B:s domänkontrakt och Licensing-specifik DB-AAL2 är dokumenterade i LICENSE_DATABASE_DESIGN.md. Ännu ej implementerad eller runtimeverifierad; inte tekniskt komplett eller verksamhetsklar.                                                                                                                                    |
