...
| Installations  | Read routes verifierade | F2C1–F2C7A:s databasgrund, server-only DAL/service samt tre dynamiska GET-routes för lista, detail och audit är lokalverifierade. Mutation Server Actions och UI saknas; Installation Management är inte verksamhetsklart. |
