...
| Installations  | Databaslagret verifierat | F2C1–F2C6A:s databasgrund, owner-read, append-only audit, atomiska mutationer samt paginerade owner-only audit- och list-read är lokalverifierade. Listsökning är låst till display name och installation code; tenantnamn och host är inte sökbara. DAL/service, routes, actions och UI saknas. |
