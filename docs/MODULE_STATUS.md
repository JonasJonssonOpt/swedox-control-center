...
Styrande 1.0-scope och stegordning finns i
[Roadmap till färdig 1.0](CONTROL_CENTER_ROADMAP_TO_1_0.md). Provisioning,
Monitoring/Alerts och Dashboard ingår i planen men är ännu inte implementerade.
Roadmapens framtida slutstatusar är krav; modulernas verifiering redovisas här.
...
| Licenses       | Historikintegritet verifierad | F2D4 lokalt verifierad 2026-09-13: append-only terms/audit och deferred strukturell validering. F2D3-access oförändrad. 1 444 pgTAP, 162 Node-test och 8 concurrencykontroller passerar. Se [verifieringsrapport](LICENSE_HISTORY_INTEGRITY_VERIFICATION.md). F2D5–F2D9 återstår; Licensing är inte komplett. Signerad runtime/cloud återstår. |
