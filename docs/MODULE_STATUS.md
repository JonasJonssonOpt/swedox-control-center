...
| Licenses       | Read security verifierad | F2D3 lokalt verifierad 2026-09-12: owner+AAL2 SELECT p? licenses/terms, audit och writes st?ngda. 1 323 pgTAP och 162 Node-test passerar. Se [verifieringsrapport](LICENSE_OWNER_AAL2_VERIFICATION.md). F2D4?F2D9 ?terst?r; ingen signerad runtime/cloud-verifiering.                                                               |
