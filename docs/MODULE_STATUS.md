...
| Licenses       | Create lokalt verifierad | F2D5A verifierad 2026-09-13: owner+AAL2 create, Tenant-lås och atomisk draft/audit/terms. F2D3/F2D4 bevaras. 1 531 pgTAP, 162 Node och 5 concurrencykontroller passerar. Se [rapport](LICENSE_MUTATION_VERIFICATION.md). F2D5B/C och F2D6–F2D9 återstår; hela F2D5 och Licensing är inte kompletta.                                 |
