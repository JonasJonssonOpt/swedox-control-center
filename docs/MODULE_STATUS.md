...
| Licenses       | Databasgrund verifierad | F2D2 lokalt verifierad 2026-09-12: 1 088 pgTAP och matchande licenstyper. Global typjämförelse passerar efter avgränsad korrigering av typgenereringen; se [verifieringsrapport](LICENSE_FOUNDATION_VERIFICATION.md). F2D3–F2D9 återstår; produkten är inte runtimeverifierad.                                                      |
